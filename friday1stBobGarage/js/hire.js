...
///savecookie named "namecookie" this saves the first and last name as a single cookie
function savefirstnamecookie(firstnamecookie) {

    setCookie(firstnamecookie, document.forms["RentalForm"]["forename"].value, 7);
}


//display the cookie name 'firstnamecookie' as a greeting on every page {
function displayfirstnameCookie(firstnamecookie) {
    document.getElementById("greeting").innerHTML = 'Hello,' + getCookie(firstnamecookie);
}
...
//VALIDATION OF FORM LIVE - ONCHANGE



//live (onchange) forename validation
function validateForename() {
        var hit = 0;
        var sn = document.forms["RentalForm"]["forename"].value;
...
//live (onchange) surname validation
...
function validateAge() {
        ...
        if (age == "") {
            document.getElementById("agev3").style.display = 'block';
            hit = 1;
        } else if (age > 16) {
            document.getElementById("agev").style.display = 'none';
            document.getElementById("agev2").style.display = 'none';
            document.getElementById("agev3").style.display = 'none';
        }

    }
    //live (onchange) email validation
function validateEmail() {
    ...
    //live (onchange) password validation
function validatePassword() {
    var hit = 0;
    var ps = document.forms["RentalForm"]["password"].value;

    if (ps == "") {
        document.getElementById("psv").style.display = 'block';
        hit = 1;
        // return false;
    } else if (ps.length < 6) {
        document.getElementById("psv1").style.display = 'block';
        hit = 1;

    } else if (ps.match(/^[A-Za-z]+$/)) {
        document.getElementById("psv2").style.display = 'block';
        hit = 1;
    } else {
        document.getElementById("psv").style.display = 'none';
        document.getElementById("psv1").style.display = 'none';
        document.getElementById("psv2").style.display = 'none';
    }

}


//live (onchange) address validation
function validateAddress() {

        var add = document.forms["RentalForm"]["address"].value;
    ...
    //live (onchange) postcode validation
...
function validateForm() {
   ...
   var fn = document.forms["RentalForm"]["forename"].value;
    ...
    if (ps == "") {
        ...
        document.getElementById("psv2").style.display = 'block';
        hit = 1;
    } else if (!ps.match(/^[A-Za-z]+$/) && ps.length > 6) {
        document.getElementById("psv").style.display = 'none';
        document.getElementById("psv1").style.display = 'none';
        document.getElementById("psv2").style.display = 'none';
    }
    ...
    // IF ANY ABOVE FIELDS ARE INVALID, RETURN FORM FALSE
